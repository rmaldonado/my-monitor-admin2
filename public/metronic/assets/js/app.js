var App = function () {
    ...
    var handleDashboardCharts = function () {
        ...
        var plot_statistics = $.plot($("#site_statistics"), [{
            ...
            xaxis: {
                ticks: [[2, '13-02-22'], [5, '13-02-22'], [15, "13-02-22"], [20, "13-02-22"], [25, "13-02-22"]]
            },
            yaxis: {
                ticks: 11,
                tickDecimals: 0
...
///
$.plot($("#region_statistics_content"), [getRandomData()]);
...
///
    ...
    var handleDateTimePickers = function () {
        ...
        function (start, end) {
            ...
            $('#dashboard-report-range span').html(start.toString('yyyy/MM/d') + ' - ' + end.toString('yyyy/MM/d'));
